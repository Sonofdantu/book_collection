class OfficerEntriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @officer_entry.save
        ...
        member.increment!(:officer_points, @officer_entry.points) if member

        format.html do
          redirect_to officer_entry_url(@officer_entry),
                      notice: 'Officer entry was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @officer_entry.update(officer_entry_params)
        format.html do
          redirect_to officer_entry_url(@officer_entry),
                      notice: 'Officer entry was successfully updated.'
        end
  ...
  def destroy
    ...
    member.decrement!(:officer_points, points_to_decrement) if member
