class FinancesController < ApplicationController
  ...
  def finance_params
    params.require(:finance).permit(:email, :eventTitle, :cost, :receipt, :reimbursement,
  ...
  def encode_uploaded_images
    ...
    return unless params[:finance][:reimbursement].is_a?(ActionDispatch::Http::UploadedFile)
